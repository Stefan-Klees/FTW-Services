...
@NamedQueries({
  ...
  , @NamedQuery(name = "Feinabstimmung.findByIdfeinabstimmung", query = "SELECT f FROM Feinabstimmung f WHERE f.idfeinabstimmung = :idfeinabstimmung")
  , @NamedQuery(name = "Feinabstimmung.findByFtwVersion", query = "SELECT f FROM Feinabstimmung f WHERE f.ftwVersion = :ftwVersion")
  , @NamedQuery(name = "Feinabstimmung.findByFtwJobsAblauf", query = "SELECT f FROM Feinabstimmung f WHERE f.ftwJobsAblauf = :ftwJobsAblauf")
  , @NamedQuery(name = "Feinabstimmung.findByRoutenJobsAblauf", query = "SELECT f FROM Feinabstimmung f WHERE f.routenJobsAblauf = :routenJobsAblauf")
  , @NamedQuery(name = "Feinabstimmung.findByLinieJobsAblauf", query = "SELECT f FROM Feinabstimmung f WHERE f.linieJobsAblauf = :linieJobsAblauf")
  , @NamedQuery(name = "Feinabstimmung.findByUkLGClass1", query = "SELECT f FROM Feinabstimmung f WHERE f.ukLGClass1 = :ukLGClass1")
  , @NamedQuery(name = "Feinabstimmung.findByUkLGClass2", query = "SELECT f FROM Feinabstimmung f WHERE f.ukLGClass2 = :ukLGClass2")
  , @NamedQuery(name = "Feinabstimmung.findByUkLGClass3", query = "SELECT f FROM Feinabstimmung f WHERE f.ukLGClass3 = :ukLGClass3")
  , @NamedQuery(name = "Feinabstimmung.findByUkLGClass4", query = "SELECT f FROM Feinabstimmung f WHERE f.ukLGClass4 = :ukLGClass4")
  , @NamedQuery(name = "Feinabstimmung.findByUkLGClass5", query = "SELECT f FROM Feinabstimmung f WHERE f.ukLGClass5 = :ukLGClass5")
  , @NamedQuery(name = "Feinabstimmung.findByUkLGClass6", query = "SELECT f FROM Feinabstimmung f WHERE f.ukLGClass6 = :ukLGClass6")
  , @NamedQuery(name = "Feinabstimmung.findByUkLGClass7", query = "SELECT f FROM Feinabstimmung f WHERE f.ukLGClass7 = :ukLGClass7")
  , @NamedQuery(name = "Feinabstimmung.findByUkLGClass8", query = "SELECT f FROM Feinabstimmung f WHERE f.ukLGClass8 = :ukLGClass8")
  , @NamedQuery(name = "Feinabstimmung.findByUkLGClass9", query = "SELECT f FROM Feinabstimmung f WHERE f.ukLGClass9 = :ukLGClass9")
  , @NamedQuery(name = "Feinabstimmung.findByUkLGClass10", query = "SELECT f FROM Feinabstimmung f WHERE f.ukLGClass10 = :ukLGClass10")
  , @NamedQuery(name = "Feinabstimmung.findByUkLGClass11", query = "SELECT f FROM Feinabstimmung f WHERE f.ukLGClass11 = :ukLGClass11")
  , @NamedQuery(name = "Feinabstimmung.findByUkLGClass12", query = "SELECT f FROM Feinabstimmung f WHERE f.ukLGClass12 = :ukLGClass12")
  , @NamedQuery(name = "Feinabstimmung.findByUkLGClass13", query = "SELECT f FROM Feinabstimmung f WHERE f.ukLGClass13 = :ukLGClass13")
  , @NamedQuery(name = "Feinabstimmung.findByUkLGClass14", query = "SELECT f FROM Feinabstimmung f WHERE f.ukLGClass14 = :ukLGClass14")
  , @NamedQuery(name = "Feinabstimmung.findByUkLGClass15", query = "SELECT f FROM Feinabstimmung f WHERE f.ukLGClass15 = :ukLGClass15")
  , @NamedQuery(name = "Feinabstimmung.findByUkLGClass16", query = "SELECT f FROM Feinabstimmung f WHERE f.ukLGClass16 = :ukLGClass16")
  , @NamedQuery(name = "Feinabstimmung.findByUkLGClass17", query = "SELECT f FROM Feinabstimmung f WHERE f.ukLGClass17 = :ukLGClass17")
  , @NamedQuery(name = "Feinabstimmung.findByUkLGClass18", query = "SELECT f FROM Feinabstimmung f WHERE f.ukLGClass18 = :ukLGClass18")
  , @NamedQuery(name = "Feinabstimmung.findByUkLGClass19", query = "SELECT f FROM Feinabstimmung f WHERE f.ukLGClass19 = :ukLGClass19")
  , @NamedQuery(name = "Feinabstimmung.findByUkLGClass20", query = "SELECT f FROM Feinabstimmung f WHERE f.ukLGClass20 = :ukLGClass20")
  , @NamedQuery(name = "Feinabstimmung.findByUkBGClass1", query = "SELECT f FROM Feinabstimmung f WHERE f.ukBGClass1 = :ukBGClass1")
  , @NamedQuery(name = "Feinabstimmung.findByUkBGClass2", query = "SELECT f FROM Feinabstimmung f WHERE f.ukBGClass2 = :ukBGClass2")
  , @NamedQuery(name = "Feinabstimmung.findByUkBGClass3", query = "SELECT f FROM Feinabstimmung f WHERE f.ukBGClass3 = :ukBGClass3")
  , @NamedQuery(name = "Feinabstimmung.findByUkBGClass4", query = "SELECT f FROM Feinabstimmung f WHERE f.ukBGClass4 = :ukBGClass4")
  , @NamedQuery(name = "Feinabstimmung.findByUkBGClass5", query = "SELECT f FROM Feinabstimmung f WHERE f.ukBGClass5 = :ukBGClass5")
  , @NamedQuery(name = "Feinabstimmung.findByUkBGClass6", query = "SELECT f FROM Feinabstimmung f WHERE f.ukBGClass6 = :ukBGClass6")
  , @NamedQuery(name = "Feinabstimmung.findByUkBGClass7", query = "SELECT f FROM Feinabstimmung f WHERE f.ukBGClass7 = :ukBGClass7")
  , @NamedQuery(name = "Feinabstimmung.findByUkBGClass8", query = "SELECT f FROM Feinabstimmung f WHERE f.ukBGClass8 = :ukBGClass8")
  , @NamedQuery(name = "Feinabstimmung.findByUkBGClass9", query = "SELECT f FROM Feinabstimmung f WHERE f.ukBGClass9 = :ukBGClass9")
  , @NamedQuery(name = "Feinabstimmung.findByUkBGClass10", query = "SELECT f FROM Feinabstimmung f WHERE f.ukBGClass10 = :ukBGClass10")
  , @NamedQuery(name = "Feinabstimmung.findByUkBGClass11", query = "SELECT f FROM Feinabstimmung f WHERE f.ukBGClass11 = :ukBGClass11")
  , @NamedQuery(name = "Feinabstimmung.findByUkBGClass12", query = "SELECT f FROM Feinabstimmung f WHERE f.ukBGClass12 = :ukBGClass12")
  , @NamedQuery(name = "Feinabstimmung.findByUkBGClass13", query = "SELECT f FROM Feinabstimmung f WHERE f.ukBGClass13 = :ukBGClass13")
  , @NamedQuery(name = "Feinabstimmung.findByUkBGClass14", query = "SELECT f FROM Feinabstimmung f WHERE f.ukBGClass14 = :ukBGClass14")
  , @NamedQuery(name = "Feinabstimmung.findByUkBGClass15", query = "SELECT f FROM Feinabstimmung f WHERE f.ukBGClass15 = :ukBGClass15")
  , @NamedQuery(name = "Feinabstimmung.findByUkBGClass16", query = "SELECT f FROM Feinabstimmung f WHERE f.ukBGClass16 = :ukBGClass16")
  , @NamedQuery(name = "Feinabstimmung.findByUkBGClass17", query = "SELECT f FROM Feinabstimmung f WHERE f.ukBGClass17 = :ukBGClass17")
  , @NamedQuery(name = "Feinabstimmung.findByUkBGClass18", query = "SELECT f FROM Feinabstimmung f WHERE f.ukBGClass18 = :ukBGClass18")
  , @NamedQuery(name = "Feinabstimmung.findByUkBGClass19", query = "SELECT f FROM Feinabstimmung f WHERE f.ukBGClass19 = :ukBGClass19")
  , @NamedQuery(name = "Feinabstimmung.findByUkBGClass20", query = "SELECT f FROM Feinabstimmung f WHERE f.ukBGClass20 = :ukBGClass20")
  , @NamedQuery(name = "Feinabstimmung.findByPkP1", query = "SELECT f FROM Feinabstimmung f WHERE f.pkP1 = :pkP1")
  , @NamedQuery(name = "Feinabstimmung.findByPkP2", query = "SELECT f FROM Feinabstimmung f WHERE f.pkP2 = :pkP2")
  , @NamedQuery(name = "Feinabstimmung.findByPkp3", query = "SELECT f FROM Feinabstimmung f WHERE f.pkp3 = :pkp3")
  , @NamedQuery(name = "Feinabstimmung.findByPkP4", query = "SELECT f FROM Feinabstimmung f WHERE f.pkP4 = :pkP4")
  , @NamedQuery(name = "Feinabstimmung.findByPkP5", query = "SELECT f FROM Feinabstimmung f WHERE f.pkP5 = :pkP5")
  , @NamedQuery(name = "Feinabstimmung.findByPkP6", query = "SELECT f FROM Feinabstimmung f WHERE f.pkP6 = :pkP6")
  , @NamedQuery(name = "Feinabstimmung.findByPkP7", query = "SELECT f FROM Feinabstimmung f WHERE f.pkP7 = :pkP7")
  , @NamedQuery(name = "Feinabstimmung.findByPkC1", query = "SELECT f FROM Feinabstimmung f WHERE f.pkC1 = :pkC1")
  , @NamedQuery(name = "Feinabstimmung.findByPkC2", query = "SELECT f FROM Feinabstimmung f WHERE f.pkC2 = :pkC2")
  , @NamedQuery(name = "Feinabstimmung.findByPkC3", query = "SELECT f FROM Feinabstimmung f WHERE f.pkC3 = :pkC3")
  , @NamedQuery(name = "Feinabstimmung.findByPkC4", query = "SELECT f FROM Feinabstimmung f WHERE f.pkC4 = :pkC4")
  , @NamedQuery(name = "Feinabstimmung.findByPkC5", query = "SELECT f FROM Feinabstimmung f WHERE f.pkC5 = :pkC5")
  , @NamedQuery(name = "Feinabstimmung.findByPkC6", query = "SELECT f FROM Feinabstimmung f WHERE f.pkC6 = :pkC6")
  , @NamedQuery(name = "Feinabstimmung.findByPkC7", query = "SELECT f FROM Feinabstimmung f WHERE f.pkC7 = :pkC7")
  , @NamedQuery(name = "Feinabstimmung.findByPreisAVGASkg", query = "SELECT f FROM Feinabstimmung f WHERE f.preisAVGASkg = :preisAVGASkg")
  , @NamedQuery(name = "Feinabstimmung.findByPreisJETAkg", query = "SELECT f FROM Feinabstimmung f WHERE f.preisJETAkg = :preisJETAkg")
  , @NamedQuery(name = "Feinabstimmung.findByAbrSicherheitsgebuehr", query = "SELECT f FROM Feinabstimmung f WHERE f.abrSicherheitsgebuehr = :abrSicherheitsgebuehr")
  , @NamedQuery(name = "Feinabstimmung.findByAbrLandegebuehr", query = "SELECT f FROM Feinabstimmung f WHERE f.abrLandegebuehr = :abrLandegebuehr")
  , @NamedQuery(name = "Feinabstimmung.findByAbrPrzBuchungsgebuehr", query = "SELECT f FROM Feinabstimmung f WHERE f.abrPrzBuchungsgebuehr = :abrPrzBuchungsgebuehr")
  , @NamedQuery(name = "Feinabstimmung.findByAbrCrewgebuehren", query = "SELECT f FROM Feinabstimmung f WHERE f.abrCrewgebuehren = :abrCrewgebuehren")
  , @NamedQuery(name = "Feinabstimmung.findByAbrFlugbegleiter", query = "SELECT f FROM Feinabstimmung f WHERE f.abrFlugbegleiter = :abrFlugbegleiter")
  , @NamedQuery(name = "Feinabstimmung.findByAbrBodenpersonalgebuehr", query = "SELECT f FROM Feinabstimmung f WHERE f.abrBodenpersonalgebuehr = :abrBodenpersonalgebuehr")
  , @NamedQuery(name = "Feinabstimmung.findByAbrPersonalkostenFluggesellschaft", query = "SELECT f FROM Feinabstimmung f WHERE f.abrPersonalkostenFluggesellschaft = :abrPersonalkostenFluggesellschaft")
  , @NamedQuery(name = "Feinabstimmung.findByBasisGewichtPassagier", query = "SELECT f FROM Feinabstimmung f WHERE f.basisGewichtPassagier = :basisGewichtPassagier")
  , @NamedQuery(name = "Feinabstimmung.findByBasisGewichtGepaeck", query = "SELECT f FROM Feinabstimmung f WHERE f.basisGewichtGepaeck = :basisGewichtGepaeck")
  , @NamedQuery(name = "Feinabstimmung.findByPreisFuerPassagier", query = "SELECT f FROM Feinabstimmung f WHERE f.preisFuerPassagier = :preisFuerPassagier")
  , @NamedQuery(name = "Feinabstimmung.findByPreisFuerGepaeckkg", query = "SELECT f FROM Feinabstimmung f WHERE f.preisFuerGepaeckkg = :preisFuerGepaeckkg")
  , @NamedQuery(name = "Feinabstimmung.findByPreisFuerCargokg", query = "SELECT f FROM Feinabstimmung f WHERE f.preisFuerCargokg = :preisFuerCargokg")})
public class Feinabstimmung implements Serializable {
  ...
  public String toString() {
    return "ftw.data.Feinabstimmung[ idfeinabstimmung=" + idfeinabstimmung + " ]";
  }
